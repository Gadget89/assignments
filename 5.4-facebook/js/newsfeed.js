  ...
  render() {
    return (
      ...
      <section>
        ...
        <div className="author_info">
          <a className="author_profile_name"> {comment.commenterProfileName}</a>
          <br></br>
          <p className="article_publish_date">{comment.commenterCommentDate}</p>
        </div>
          <p className="post_content">{comment.commenterCommentBodyText}</p>
        <div className="user_interaction_section">
          <button className="like_button">Like</button>
          <button className="comment_button">Commment</button>
        </div>
